<?php 
/* Template Name: service-webdesign */
get_header();
?>
	 ...
	 <div class="title-section"> 
	  ...
	  <div class="row">
		<div class="col-md-10">
		  ...
		  <p>Our web designers can offer you a fully fledged website, email addresses and more.</p> 
		  <ul>
			<li>HTML/CSS</li>
			<li>Domain Name Registration (.com, .co.uk, org etc.)</li>
			<li>Web Hosting</li>
			<li>Personalised Email Accounts (yourname@yourwebsite.com)</li>
