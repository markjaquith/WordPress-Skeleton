...
! function(a) {
    ...
    c.prototype = {
        ...
        a("html").on("click.dropdown.data-api disable-touchstart.dropdown.data-api", d), a("body").on("click.dropdown disable-touchstart.dropdown.data-api", ".dropdown form", function(a) {
            a.stopPropagation()
        }).on("click.dropdown.data-api disable-touchstart.dropdown.data-api", b, c.prototype.toggle).on("keydown.dropdown.data-api disable-touchstart.dropdown.data-api", b + ", [role=menu]", c.prototype.keydown)
    })
}(window.jQuery), ! function(a) {
    function b(b, c) {
